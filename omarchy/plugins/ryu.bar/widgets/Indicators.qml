...
BarWidget {
  ...
  Row {
    ...
    Item {
      ...
      readonly property real targetWidth: root.revealInactiveIndicators ? inactiveHorizontalBlock.implicitWidth : 0
      implicitWidth: width
  ...
  Column {
    ...
    Item {
      ...
      readonly property real targetHeight: root.revealInactiveIndicators ? inactiveVerticalBlock.implicitHeight : 0
